...
strcpy (c, stroka.c_str());
  if        (c[0] == -48 && c[1] >=-80  && c[1] <=-65) 	c[1] -= 32;
  else if   (c[0] == -47 && c[1] >=-128 && c[1] <=-113) {c[0] = -48; c[1] += 32;}
  else if   (c[0] == -47 && c[1] ==-111 ) {c[0] = -48; 	c[1] = -127;}
return ((string)c);
}
...
for (int i = 0; i<= stroka.length(); i +=1)
  {
  if        (c[i] == -48 && c[i + 1] >=-112 && c[i + 1] <=-97) {c[i + 1] = c[i + 1] + 32;}
  else if   (c[i] == -48 && c[i + 1] >=-96  && c[i + 1] <=-81) {c[i] = -47; c[i + 1] = c[i + 1] - 32;}
  else if   (c[i] == -48 && c[i + 1] == -127 ) {c[i] = -47; c[i + 1] = -111;}
  }  
return ((string)c);
}
...
{
string file_name = "/home/ubuntu/bot/var/" + name + ".txt";	
...
for (int i = 1; i<= 999; i++)	
{
	string file_name = "/home/ubuntu/bot/data/" + to_string(i) + ".txt";	//Имя файла с распределенными по смещениям фразами 1.txt
	ifstream file(file_name);															
...
for (int i = 1; i<= 999; i++)	
{
	string file_name = "/home/ubuntu/bot/data/i" + to_string(i) + ".txt";	//Имя файла с линейными фразами i1.txt
	ifstream file(file_name);
	if (!file) return i - 1;  											//Проверка наличия файла
	file.close();
}
...
for (int i = 1; i<= 999; i++)	
{
	string file_name = "/home/ubuntu/bot/data/" + to_string(i) + ".txt";	//Имя выходного файла с распределенными по смещениям фразами 1.txt
	ifstream file(file_name);
...
{
	string file_name = "/home/ubuntu/bot/data/" + to_string(file_number) + ".txt";
...
{
	string file_name = "/home/ubuntu/bot/data/" + name;
...
{
	string ifile_name = "/home/ubuntu/bot/data/i" + to_string(i) + ".txt";					//Имя входного файла i1.txt
	string ofile_name = "/home/ubuntu/bot/data/" + to_string(i) + ".txt";					//Имя выходного файла с распределенными по смещениям фразами 1.txt
...
for (int i = start_number; i<= end_number; i++)	
{
	string ifile_name = "/home/ubuntu/bot/data/" + to_string(i) + ".txt";					//Имя входного файла с распределенными по смещениям фразами 1.txt
	string ofile_name = "/home/ubuntu/bot/data/i" + to_string(i) + ".txt";					//Имя выходного файла с линейными строками i1.txt
...
string ofile_name = "/home/ubuntu/bot/data/Keywords.txt";
...
{	
	string ifile_name = "/home/ubuntu/bot/data/" + to_string(i) + ".txt", str;					//Имя форматированного файла 1.txt
...
{
string str_out = "";
string file_name = "/home/ubuntu/bot/data/" + to_string(number) + ".txt";				//Имя выходного файла с распределенными по смещениям фразами 1.txt
...
{
	ifstream file("/home/ubuntu/bot/data/Keywords.txt");										//Открытие файла Keywords.txt для чтения
...
{
	string file_name = "/home/ubuntu/bot/data/" + to_string(file_number) + ".txt";			//Имя входного файла типа 1.txt
...
for (int i = start_number; i<= end_number; i++)	
{
	string file_name = "/home/ubuntu/bot/data/" + to_string(i) + ".txt";					
...
for (int i = start_number; i<= end_number; i++)	
{
	string file_name = "/home/ubuntu/bot/data/i" + to_string(i) + ".txt";					
...
string FileWrite (int file_number, string& str_2, string& str_3)
{
	...
	string file_name = "/home/ubuntu/bot/data/" + to_string(file_number) + ".txt";	//Имя файла с распределенными по смещениям фразами типа 1.txt
